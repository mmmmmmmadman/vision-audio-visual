...
class MIDILearnManager:
    ...
    def __init__(self, config_path: str = None):
        ...
        # MIDI mappings: {(channel, cc): parameter_id}
    ...
    def load_mappings(self):
        ...
        if os.path.exists(self.config_path):
            try:
                ...
                print(f"✓ Loaded {len(self.mappings)} MIDI mappings")
    ...
    def save_mappings(self):
        ...
        try:
            ...
            data = {f"{k[0]},{k[1]}": v for k, v in self.mappings.items()}
            with open(self.config_path, 'w') as f:
                json.dump(data, f, indent=2)
            print(f"✓ Saved {len(self.mappings)} MIDI mappings")
        except Exception as e:
    ...
    def clear_mapping(self, param_id: str):
        ...
        for key in keys_to_remove:
            ...
            print(f"✓ Cleared MIDI mapping for '{param_id}'")
